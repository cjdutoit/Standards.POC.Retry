...
namespace Standards.POC.Retry.Api.Services
{
        ...
        public void GenerateBuildScript()
        {
            var githubPipeline = new GithubPipeline
            {
                ...
                OnEvents = new Events
                {
                    Push = new PushEvent
                    {
                        Branches = new string[] { " users/cjdutoit/brokers-loggers-logcritical" }
                    },
                ...
                Jobs = new Jobs
                {
                    Build = new BuildJob
                    {
                        ...
                        Steps = new List<GithubTask>
                        {
                            ...
                            {
                                Name = "Provision",
                                Run = "dotnet run --project .\\Standards.POC.Retry.Api.Infrastructure.Provision\\Standards.POC.Retry.Api.Infrastructure.Provision.csproj"
                            }
                        }
                    }
                }
